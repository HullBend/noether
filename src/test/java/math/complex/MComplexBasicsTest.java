...
public final class MComplexBasicsTest {
    ...
    public void testConstructor() {
        IComplex z = new MComplex(3.0, 4.0);
    ...
    public void testConstructorNaN() {
        IComplex z = new MComplex(3.0, Double.NaN);
        Assert.assertTrue(z.isNan());

        z = new MComplex(nan, 4.0);
        Assert.assertTrue(z.isNan());

        z = new MComplex(3.0, 4.0);
    ...
    public void testAbsNaN() {
        ...
        IComplex z = new MComplex(nan, nan);
        double abs = z.abs();
    ...
    public void testAbsNaNInf() {
        ...
        IComplex z = new MComplex(inf, nan);
        double abs = z.abs();
    ...
    public void testAbsInfinite() {
        IComplex z = new MComplex(inf, 0);
        Assert.assertEquals(inf, z.abs(), 0);
        z = new MComplex(0, neginf);
        Assert.assertEquals(inf, z.abs(), 0);
        z = new MComplex(inf, neginf);
        Assert.assertEquals(inf, z.abs(), 0);
    }
    ...
    public void testAdd() {
        ...
        IComplex y = new MComplex(5.0, 6.0);
        IComplex z = x.add(y);
    ...
    public void testDivideReal() {
        IComplex x = new MComplex(2d, 3d);
        IComplex y = new MComplex(2d, 0d);
        Assert.assertEquals(new MComplex(1d, 1.5), x.div(y));
    }

    @Test
    public void testDivideImaginary() {
        IComplex x = new MComplex(2d, 3d);
        IComplex y = new MComplex(0d, 2d);
        Assert.assertEquals(new MComplex(1.5d, -1d), x.div(y));
    }

    @Test
    public void testDivideInf() {
        IComplex x = new MComplex(3, 4);
        IComplex w = new MComplex(neginf, inf);
        Assert.assertTrue(x.div(w).equals(IComplex.Zero));

        IComplex z = w.div(new MComplex(3, 4));
        Assert.assertTrue(Double.isNaN(z.re()));
        Assert.assertEquals(inf, z.im(), 0);

        w = new MComplex(inf, inf);
        z = w.div(new MComplex(3, 4));
        Assert.assertTrue(Double.isNaN(z.im()));
        Assert.assertEquals(inf, z.re(), 0);

        w = new MComplex(1, inf);
        z = w.div(w);
        Assert.assertTrue(Double.isNaN(z.re()));
        Assert.assertTrue(Double.isNaN(z.im()));
    }
    ...
    public void testDivideZeroZero() {
        IComplex x = new MComplex(0.0, 0.0);
        IComplex z = x.div(IComplex.Zero);
        Assert.assertEquals(z, IComplex.NaN);
    }
    ...
    @Test
    public void testInv() {
        IComplex z = new MComplex(5.0, 6.0);
        IComplex act = z.inv();
    ...
    public void testInvReal() {
        IComplex z = new MComplex(-2.0, 0.0);
        Assert.assertEquals(new MComplex(-0.5, 0.0), z.inv());
    }

    @Test
    public void testInvImaginary() {
        IComplex z = new MComplex(0.0, -2.0);
        Assert.assertEquals(new MComplex(0.0, 0.5), z.inv());
    }

    @Test
    public void testInvInf() {
        IComplex z = new MComplex(neginf, inf);
        Assert.assertTrue(z.inv().equals(IComplex.Zero));

        z = new MComplex(1, inf).inv();
    ...
    public void testMultiplyNaNInf() {
        IComplex z = new MComplex(1, 1);
        IComplex w = z.mul(infOne);
        Assert.assertEquals(w.re(), inf, 0);
        Assert.assertEquals(w.im(), inf, 0);

        // multiplications with infinity
        Assert.assertTrue(new MComplex(1, 0).mul(infInf).equals(IComplex.Inf));
        Assert.assertTrue(new MComplex(-1, 0).mul(infInf).equals(IComplex.Inf));
        Assert.assertTrue(new MComplex(1, 0).mul(negInfZero).equals(IComplex.Inf));
        ...
        z = new MComplex(1, neginf);
        Assert.assertEquals(IComplex.Inf, z.mul(z));
    }
    ...
    public void testScale() {
        IComplex x = new MComplex(3.0, 4.0);
        double yDouble = 2.0;
        IComplex yComplex = new MComplex(yDouble);
        Assert.assertEquals(x.mul(yComplex), x.scale(yDouble));
        int zInt = -5;
        IComplex zComplex = new MComplex(zInt);
    ...
    public void testSubtractInf() {
        IComplex x = new MComplex(1, 1);
        IComplex z = new MComplex(neginf, 0);
        IComplex w = x.sub(z);
        Assert.assertEquals(w.im(), 1, 0);
        Assert.assertEquals(inf, w.re(), 0);
    ...
    public void testEqualsTrue() {
        IComplex x = new MComplex(3.0, 4.0);
        IComplex y = new MComplex(3.0, 4.0);
    ...
    public void testEqualsRealDifference() {
        IComplex x = new MComplex(0.0, 0.0);
        IComplex y = new MComplex(0.0 + Double.MIN_VALUE, 0.0);
    ...
    public void testEqualsImaginaryDifference() {
        IComplex x = new MComplex(0.0, 0.0);
        IComplex y = new MComplex(0.0, 0.0 + Double.MIN_VALUE);
        Assert.assertFalse(x.equals(y));
    }

    @Test
    public void testEqualsNaN() {
        IComplex realNaN = new MComplex(Double.NaN, 0.0);
        IComplex imaginaryNaN = new MComplex(0.0, Double.NaN);
    ...
    @Test
    public void testExp() {
        IComplex z = new MComplex(3, 4);
        IComplex expected = new MComplex(-13.12878, -15.20078);
        TestUtils.assertEquals(expected, z.exp(), 1.0e-5);
        TestUtils.assertEquals(IComplex.One, IComplex.Zero.exp(), 10e-12);
        IComplex iPi = IComplex.I.mul(new MComplex(pi, 0));
        TestUtils.assertEquals(IComplex.One.neg(), iPi.exp(), 10e-12);
    }
    ...
    public void testLn() {
        IComplex z = new MComplex(3, 4);
        IComplex expected = new MComplex(1.60944, 0.927295);
    ...
    public void testLogInf() {
        TestUtils.assertEquals(new MComplex(inf, pi / 2), oneInf.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, -pi / 2), oneNegInf.ln(), 10e-12);
        TestUtils.assertEquals(infZero, infOne.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, pi), negInfOne.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, pi / 4), infInf.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, -pi / 4), infNegInf.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, 3d * pi / 4), negInfInf.ln(), 10e-12);
        TestUtils.assertEquals(new MComplex(inf, -3d * pi / 4), negInfNegInf.ln(), 10e-12);
    }
    ...
    public void testPow() {
        IComplex x = new MComplex(3, 4);
        IComplex y = new MComplex(5, 6);
        IComplex expected = new MComplex(-1.860893, 11.83677);
    ...
    public void testPowZero() {
        TestUtils.assertSame(IComplex.NaN, IComplex.Zero.pow(IComplex.One));
        TestUtils.assertSame(IComplex.NaN, IComplex.Zero.pow(IComplex.Zero));
        TestUtils.assertSame(IComplex.NaN, IComplex.Zero.pow(IComplex.I));
        TestUtils.assertEquals(IComplex.One, IComplex.One.pow(IComplex.Zero), 10e-12);
        TestUtils.assertEquals(IComplex.One, IComplex.I.pow(IComplex.Zero), 10e-12);
        TestUtils.assertEquals(IComplex.One, new MComplex(-1, 3).pow(IComplex.Zero), 10e-12);
    }
    ...
    public void testScalarPowZero() {
        ...
        TestUtils.assertEquals(IComplex.One, new MComplex(-1, 3).pow(0.0), 10e-12);
    }
    ...
    public void testEqualsIssue() {
        Assert.assertEquals(new MComplex(0, -1), new MComplex(0, 1).mul(new MComplex(-1, 0)));
    }
